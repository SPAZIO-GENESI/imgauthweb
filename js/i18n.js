...
(function () {
  const DICT = {
    it: {
      ...
      "txt.labelRiserva":            "Riserva dei diritti:   ",
      "txt.riservaNotAllowed":       "non acconsento all'uso per addestrare sistemi di AI",
      "txt.riservaConstrained":      "acconsento solo a condizioni da concordare",
      "txt.riservaAllowed":          "acconsento",
      ...
      "cert.campoAnno":                  "anno",
      "cert.campoNote":                  "note",
      "cert.campoRiserva":               "riserva dei diritti",
    ...
    en: {
      ...
      "txt.labelRiserva":            "Rights reservation:    ",
      "txt.riservaNotAllowed":       "does not consent to use for training AI systems",
      "txt.riservaConstrained":      "consents only under conditions to be agreed",
      "txt.riservaAllowed":          "consents",
      ...
      "cert.campoRiserva":               "rights reservation",
